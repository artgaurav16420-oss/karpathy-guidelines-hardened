...
- `skills/karpathy-guidelines/assets/reference-line.md`: extracted MANDATORY reference line as single source; SKILL.md prepend logic and `agents-template.md` `__KARPATHY_MANDATORY_LINE__` placeholder resolve to it
