...
When you update the guidelines, keep **[`CLAUDE.md`](CLAUDE.md)**, **[`README.md`](README.md)**, **[`EXAMPLES.md`](EXAMPLES.md)**, **[`README.zh.md`](README.zh.md)**, and **[`.cursor/rules/karpathy-guidelines.mdc`](.cursor/rules/karpathy-guidelines.mdc)** in sync. If the published skill/plugin text should match, update **[`skills/karpathy-guidelines/SKILL.md`](skills/karpathy-guidelines/SKILL.md)** as well.
